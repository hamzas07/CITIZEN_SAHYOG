...
export default function Dashboard() {
  ...
  // ---------------- FETCH ALL COMPLAINTS (GLOBAL FEED) ----------------
  useEffect(() => {
    const fetchComplaints = async () => {
      try {
        const data = await getAllComplaints();

        // 🔥 UNIVERSAL FEED: show ALL complaints
    ...
    <div className="space-y-8">
      ...
      <div className="animate-fade-in relative">
        ...
        <p className="text-muted-foreground mt-2 max-w-lg">
          View and track complaints raised by citizens across the community.
        ...
        {complaints.length === 0 && (
          <div className="text-center py-16 glass-strong rounded-2xl">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
              Be the first to raise a concern and help improve public services.
            </p>
            <Link
              to="/new-complaint"
